...
```bash
cloudflare-logs-forwarder$ sam build
```
...
```bash
cloudflare-logs-forwarder$ sam local start-api
cloudflare-logs-forwarder$ curl http://localhost:3000/
```
...
```bash
cloudflare-logs-forwarder$ sam logs -n HelloWorldFunction --stack-name cloudflare-logs-forwarder --tail
```
...
```bash
cloudflare-logs-forwarder$ cd HelloWorldFunction
